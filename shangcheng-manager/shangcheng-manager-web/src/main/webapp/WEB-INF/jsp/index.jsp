...
<head>
    ...
    <![endif]-->
    <title>商城后台管理系统 v1.1</title>
    <meta name="keywords" content="商城后台管理系统 v1.1,XMall,XMall购物商城后台管理系统">
    <meta name="description" content="后台管理系统 v1.1，是一款电商后台管理系统，适合中小型CMS后台系统。">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/">商城后台管理系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/">商城后台管理系统</a>
            ...
            <%--<nav class="nav navbar-nav">
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        ...
                        &lt;%&ndash;<li class="navbar-levelone"><a href="javascript:;">财务</a></li>
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="activity" data-title="活动列表" href="javascript:void(0)">活动列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-order">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="orderItem-list" data-title="订单项列表" href="javascript:void(0)">订单项列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-search">
