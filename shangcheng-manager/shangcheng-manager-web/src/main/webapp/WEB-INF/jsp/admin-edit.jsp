...
<article class="page-container">
    <form class="form form-horizontal" id="form-admin-add">
        <input type="text" hidden value="" placeholder="" id="id" name="aid">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="phone" name="tell">
            </div>
        </div>
       <%-- <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <span class="select-box" style="width:150px;">
                    <select id="select" class="select" name="power">
...
<script type="text/javascript">
    ...
    $("#phone").val(parent.tell);
    $("#select").val(parent.power);
   ...
   //获取所有权限
    ...
    $.ajax({
        url:"${pageContext.request.contextPath}/admin/getAllRoles",
        type: 'GET',
        ...
        $("#form-admin-add").validate({
            rules:{
                username:{
                    ...
                    minlength:1,
                    maxlength:16,
                    remote: "${pageContext.request.contextPath}/admin/edit/username?aid="+$("#id").val()
                },
               /* sex:{
                    required:true,
                },*/
                phone:{
                    required:true,
                    /*isPhone:true,*/
                    remote: "${pageContext.request.contextPath}/admin/edit/tell?aid="+$("#id").val()
                }/*,
                email:{
                    required:true,
                    email:true,
