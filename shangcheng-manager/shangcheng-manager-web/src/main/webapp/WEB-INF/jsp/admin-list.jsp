...
<script type="text/javascript">
            ...
            "columns": [
               ...
               /* { "data": "sex"},*/
                ...
                },*/
                {
                    "data": null,
                    render : function(data) {
                            return "</a> <a title=\"编辑\" href=\"javascript:;\" onclick=\"admin_edit('编辑','admin-edit',"+data.aid+",'',500)\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> " +
                                "<a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"change_password('修改密码','change-admin-password',"+data.aid+",'600','270')\" href=\"javascript:;\" title=\"修改密码\"><i class=\"Hui-iconfont\">&#xe63f;</i></a>" +
                                " <a title=\"删除\" href=\"javascript:;\" onclick=\"admin_del("+data.aid+")\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                    }
                }
            ],
    ...
    function userCount() {
        $.ajax({
            url:"${pageContext.request.contextPath}/admin/adminCount",
            type: 'GET',
    ...
    function admin_del(id){
        layer.confirm('确认要删除ID为\''+id+'\'的用户吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/admin/delAdmin?aid='+id,
                dataType: 'json',
                success: function(data){
                    layer.close(index);
                    if(data.success!=true){
    ...
    function datadel() {
        ...
        layer.confirm('确认要删除所选的'+count+'条数据吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'GET',
                url: '${pageContext.request.contextPath}/admin/delMoreAdmin?ids='+ids,
                dataType: 'json',
                success:function(data){
                    layer.close(index);
                    if(data.success!=true){
    ...
    var username="",userId=-1,tell="",power=""/*,email="",roleNames="",sex="",description=""*/;
    ...
    function admin_edit(title,url,id,w,h){
        ...
        $('.table tbody').on( 'click', 'tr', function () {
            ...
            tell = table.row(this).data().tell;
            power = table.row(this).data().power;
