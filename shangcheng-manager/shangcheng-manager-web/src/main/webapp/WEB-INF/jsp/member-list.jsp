    ...
    $(function() {
        $('.table').dataTable({
            ...
            "columns": [
                ...
                { "data": null,
                    render : function(data) {
//                            return "<a id=\"td-manage\" style=\"text-decoration:none\" onClick=\"member_stop(this,"+data+")\" href=\"javascript:;\" title=\"停用\"><i class=\"Hui-iconfont\">&#xe631;</i></a> <a title=\"编辑\" href=\"javascript:;\" onclick=\"member_edit('编辑','member-edit',"+row.id+",'','510')\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6df;</i></a> <a style=\"text-decoration:none\" class=\"ml-5\" onClick=\"change_password('修改密码','change-password',"+data+",'600','270')\" href=\"javascript:;\" title=\"修改密码\"><i class=\"Hui-iconfont\">&#xe63f;</i></a> <a title=\"删除\" href=\"javascript:;\" onclick=\"member_del(this,"+data+")\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
                           return "<a title=\"删除\" href=\"javascript:;\" onclick=\"member_del("+data.uid+")\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"Hui-iconfont\">&#xe6e2;</i></a>";
    ...
    function member_count(){
        $.ajax({
            url:"${pageContext.request.contextPath}/user/getUserCount",
            type:"GET",
            success:function (data) {
                $("#memberListCount").html(data.count);
            }
   ...
   /* function member_start(obj,id){
    ...
    function datadel() {
        ...
        layer.confirm('确认要删除所选的'+count+'条数据吗？',{icon:0},function(index){
            ...
            $.ajax({
                type: 'get',
                url: '${pageContext.request.contextPath}/user/delMoreUser?ids='+ids,
                dataType: 'json',
                success:function(data){
                    layer.close(index);
                    if(data.flag!=true){
